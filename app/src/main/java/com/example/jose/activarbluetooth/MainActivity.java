package com.example.jose.activarbluetooth;
        ...
        switch (requestCode){
            case CODIGO_SOLICITUD_PERMISO:
                if (checarStatusPermiso()) {
                    Toast.makeText(MainActivity.this, "Ya esta activo el bluetooth ", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(MainActivity.this, "No esta activo el bluetooth ", Toast.LENGTH_SHORT).show();
                }
